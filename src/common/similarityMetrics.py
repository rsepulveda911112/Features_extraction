...
class SimilarityMetrics():
    ...
    def get_kullback_leibler(self,text1, text2):
        bow_text1 = self.model.id2word.doc2bow(text1)
        bow_text2 = self.model.id2word.doc2bow(text2)
        lda_bow_text1 = self.model[bow_text1]
        lda_bow_text2 = self.model[bow_text2]
    ...
    def all_metrics(self, doc1, doc2):
        return self.get_hellinger(doc1, doc2), self.get_jaccard(doc1, doc2), self.get_kullback_leibler(doc2, doc1)
